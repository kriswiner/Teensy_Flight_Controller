...
void SENtralPassThroughMode()
{
  ...
  uint8_t c = em7180.readByte(EM7180_ADDRESS, EM7180_AlgorithmControl);
  em7180.writeByte(EM7180_ADDRESS, EM7180_AlgorithmControl, c | 0x01);
  // Place SENtral in pass-through mode
  em7180.writeByte(EM7180_ADDRESS, EM7180_PassThruControl, 0x01); 
  if(em7180.readByte(EM7180_ADDRESS, EM7180_PassThruStatus) & 0x01) {
    pc.printf("SENtral inpass-through mode");
  }
  else {
    pc.printf("ERROR! SENtral not in pass-through mode!");
  }
